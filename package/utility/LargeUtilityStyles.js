...
export const largeUtilityStyles = {
  ...
  lgMx1: { marginLeft: LARGE_MARGIN * 1 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * 1 + PX_TAG + IMPORTANT },
  lgMx2: { marginLeft: LARGE_MARGIN * 2 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * 2 + PX_TAG + IMPORTANT },
  lgMx3: { marginLeft: LARGE_MARGIN * 3 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * 3 + PX_TAG + IMPORTANT },
  lgMx4: { marginLeft: LARGE_MARGIN * 4 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * 4 + PX_TAG + IMPORTANT },
  lgMx5: { marginLeft: LARGE_MARGIN * 5 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * 5 + PX_TAG + IMPORTANT },
  lgMxAuto: { marginLeft: "auto" + IMPORTANT, marginRight: "auto" + IMPORTANT },

  lgMy0: { marginTop: 0, marginBottom: 0 + IMPORTANT },
  lgMy1: { marginTop: LARGE_MARGIN * 1 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * 1 + PX_TAG + IMPORTANT },
  lgMy2: { marginTop: LARGE_MARGIN * 2 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * 2 + PX_TAG + IMPORTANT },
  lgMy3: { marginTop: LARGE_MARGIN * 3 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * 3 + PX_TAG + IMPORTANT },
  lgMy4: { marginTop: LARGE_MARGIN * 4 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * 4 + PX_TAG + IMPORTANT },
  lgMy5: { marginTop: LARGE_MARGIN * 5 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * 5 + PX_TAG + IMPORTANT },
  ...
  lgMxN1: { marginLeft: LARGE_MARGIN * -1 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * -1 + PX_TAG + IMPORTANT },
  lgMxN2: { marginLeft: LARGE_MARGIN * -2 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * -2 + PX_TAG + IMPORTANT },
  lgMxN3: { marginLeft: LARGE_MARGIN * -3 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * -3 + PX_TAG + IMPORTANT },
  lgMxN4: { marginLeft: LARGE_MARGIN * -4 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * -4 + PX_TAG + IMPORTANT },
  lgMxN5: { marginLeft: LARGE_MARGIN * -5 + PX_TAG + IMPORTANT, marginRight: LARGE_MARGIN * -5 + PX_TAG + IMPORTANT },

  lgMyN1: { marginTop: LARGE_MARGIN * -1 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * -1 + PX_TAG + IMPORTANT },
  lgMyN2: { marginTop: LARGE_MARGIN * -2 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * -2 + PX_TAG + IMPORTANT },
  lgMyN3: { marginTop: LARGE_MARGIN * -3 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * -3 + PX_TAG + IMPORTANT },
  lgMyN4: { marginTop: LARGE_MARGIN * -4 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * -4 + PX_TAG + IMPORTANT },
  lgMyN5: { marginTop: LARGE_MARGIN * -5 + PX_TAG + IMPORTANT, marginBottom: LARGE_MARGIN * -5 + PX_TAG + IMPORTANT },
