...
export const mediumUtilityStyles = {
  ...
  mdMx1: { marginLeft: MEDIUM_MARGIN * 1, marginRight: MEDIUM_MARGIN * 1 + PX_TAG + IMPORTANT },
  mdMx2: { marginLeft: MEDIUM_MARGIN * 2, marginRight: MEDIUM_MARGIN * 2 + PX_TAG + IMPORTANT },
  mdMx3: { marginLeft: MEDIUM_MARGIN * 3, marginRight: MEDIUM_MARGIN * 3 + PX_TAG + IMPORTANT },
  mdMx4: { marginLeft: MEDIUM_MARGIN * 4, marginRight: MEDIUM_MARGIN * 4 + PX_TAG + IMPORTANT },
  mdMx5: { marginLeft: MEDIUM_MARGIN * 5, marginRight: MEDIUM_MARGIN * 5 + PX_TAG + IMPORTANT },
  mdMxAuto: { marginLeft: "auto" + IMPORTANT, marginRight: "auto" + IMPORTANT },

  mdMy0: { marginTop: 0 + IMPORTANT, marginBottom: 0 + IMPORTANT },
  mdMy1: { marginTop: MEDIUM_MARGIN * 1, marginBottom: MEDIUM_MARGIN * 1 + PX_TAG + IMPORTANT },
  mdMy2: { marginTop: MEDIUM_MARGIN * 2, marginBottom: MEDIUM_MARGIN * 2 + PX_TAG + IMPORTANT },
  mdMy3: { marginTop: MEDIUM_MARGIN * 3, marginBottom: MEDIUM_MARGIN * 3 + PX_TAG + IMPORTANT },
  mdMy4: { marginTop: MEDIUM_MARGIN * 4, marginBottom: MEDIUM_MARGIN * 4 + PX_TAG + IMPORTANT },
  mdMy5: { marginTop: MEDIUM_MARGIN * 5, marginBottom: MEDIUM_MARGIN * 5 + PX_TAG + IMPORTANT },
